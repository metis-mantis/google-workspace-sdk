# Google Workspace SDK Python API library
...
pip install git+ssh://git@github.com/metis-mantis/google-workspace-sdk.git
```
...
```sh
# install from the production repo
pip install 'google_workspace_sdk[aiohttp] @ git+ssh://git@github.com/metis-mantis/google-workspace-sdk.git'
```
